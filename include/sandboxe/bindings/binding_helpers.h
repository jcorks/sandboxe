...
#define SANDBOXE_ASSERT__ARG_TYPE(__I__, __T__) if (arguments[__I__].hint != Sandboxe::Script::Runtime::Primitive::TypeHint::__T__) {context.ScriptError(Dynacoe::Chain() << "Sanboxe assertion failure: argument " << __I__ << " is of an unsupported type."); return;}
